    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="healthyfood.php">healthy food <img src="../img/healthy.png" style="width: 25px;height: 25px" align="right"></a></li>
                <li ><a href="drinks.php">drinks <img src="../img/drink.png" style="width: 25px;height: 25px" align="right"></a></li>
